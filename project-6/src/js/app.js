App = {
    ...
    setForm: function (item) {
        ...
        $("#originFarmerID").val(item.originFarmerID);
        $("#originFarmName").val(item.originFarmName);
        $("#originFarmInformation").val(item.originFarmInformation);
        $("#originFarmLatitude").val(item.originFarmLatitude);
        $("#originFarmLongitude").val(item.originFarmLongitude);

        $("#productNotes").val(item.productNotes);
        $("#productPrice").val(item.productPrice);
        $("#distributorID").val(item.distributorID);
        $("#retailerID").val(item.retailerID);
        $("#consumerID").val(item.consumerID);

        var state;
        switch (parseInt(item.itemState)) {
            case 0:
                state = "Harvested";
                break;
            case 1:
